        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form class="" action="{{route('editbannerP')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                  ...
                  @enderror" name="desc" id="" cols="80" rows="10">{{$user->desc}}</textarea>
                  </div>
